...
function pcheck(username) {
    ...
    request({
        ...
        process.title = `[313][Tiktok Usernames Checker] - ${checked}/${usernames.length} Total Checked | ${available} Available/banned | ${unavailable} Unavailable | ${rate} Rate Limited | Retries ${retries}`;
    });
}
...
function printAsciiLogo() {
    ...
    ╚══██╔══╝██║██║ ██╔╝╚══██╔══╝██╔═══██╗██║ ██╔╝    ██╔════╝██║  ██║██╔════╝██╔════╝██║ ██╔╝██╔════╝██╔══██╗
       ...
       ╚═╝   ╚═╝╚═╝  ╚═╝   ╚═╝    ╚═════╝ ╚═╝  ╚═╝     ╚═════╝╚═╝  ╚═╝╚══════╝ ╚═════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝
												`));
    console.log("");
	process.title = `[313] [Tiktok Usernames Checker V2] Created By Naix`;
    console.log(`[${chalk.green('!')}] Tiktok Checker V2 | Created by ${chalk.bold.red('Naix')} | Join! discord.gg/QDbZExbKMJ for support!`);
}
printAsciiLogo();
